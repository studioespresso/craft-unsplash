 ...
 * @since     1.0.0
 */
class SplashingImagesService extends Component
{
    // Public Methods
    // =========================================================================
     ...
     *
     *     SplashingImages::$plugin->splashingImagesService->exampleService()
     *
     * @return mixed
     */
    public function exampleService()
    {
        ...
        if (SplashingImages::$plugin->getSettings()->someAttribute) {
        }
